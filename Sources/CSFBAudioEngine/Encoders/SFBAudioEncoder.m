...
+ (void)load {
    [NSError
          setUserInfoValueProviderForDomain:SFBAudioEncoderErrorDomain
...
+ (void)registerSubclass:(Class)subclass priority:(int)priority {
    //    NSAssert([subclass isKindOfClass:[self class]], @"Unable to register class '%@' because it is not a subclass
    //    of SFBAudioEncoder", NSStringFromClass(subclass));
