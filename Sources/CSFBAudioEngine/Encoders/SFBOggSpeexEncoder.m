...
- (BOOL)openReturningError:(NSError **)error {
    ...
    for (;;) {
        ...
        if (![_outputWriter writeBytes:og.header length:og.header_len bytesWritten:&bytesWritten error:error] ||
        ...
        if (![_outputWriter writeBytes:og.body length:og.body_len bytesWritten:&bytesWritten error:error] ||
