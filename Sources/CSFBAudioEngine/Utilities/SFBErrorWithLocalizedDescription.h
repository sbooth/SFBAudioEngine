...
NSError * SFBErrorWithLocalizedDescription(NSErrorDomain domain, NSInteger code, NSString * _Nonnull format, NSDictionary * _Nullable userInfo, ...) NS_FORMAT_FUNCTION(3,5);
