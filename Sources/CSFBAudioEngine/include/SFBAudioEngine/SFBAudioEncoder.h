...
/// Returns an initialized `SFBAudioEncoder` object for the given output writer or `nil` on failure
/// - parameter outputWriter: The output writer
/// - returns: An initialized `SFBAudioEncoder` object for the specified output writer, or `nil` on failure
- (nullable instancetype)initWithOutputWriter:(SFBOutputWriter *)outputWriter
        NS_SWIFT_UNAVAILABLE("Use -initWithOutputWriter:error: instead");
/// Returns an initialized `SFBAudioEncoder` object for the given output writer or `nil` on failure
/// - parameter outputWriter: The output writer
/// - parameter error: An optional pointer to an `NSError` object to receive error information
/// - returns: An initialized `SFBAudioEncoder` object for the specified output writer, or `nil` on failure
- (nullable instancetype)initWithOutputWriter:(SFBOutputWriter *)outputWriter error:(NSError **)error;
/// Returns an initialized `SFBAudioEncoder` object for the given output writer or `nil` on failure
/// - parameter outputWriter: The output writer
/// - parameter mimeType: The MIME type of `outputWriter` or `nil`
/// - parameter error: An optional pointer to an `NSError` object to receive error information
/// - returns: An initialized `SFBAudioEncoder` object for the specified output writer, or `nil` on failure
- (nullable instancetype)initWithOutputWriter:(SFBOutputWriter *)outputWriter
...
- (nullable instancetype)initWithOutputWriter:(SFBOutputWriter *)outputWriter
                                  encoderName:(SFBAudioEncoderName)encoderName
        NS_SWIFT_UNAVAILABLE("Use -initWithOutputWriter:encoderName:error: instead");
/// Returns an initialized `SFBAudioEncoder` object for the given output writer or `nil` on failure
/// - parameter outputWriter: The output writer
/// - parameter encoderName: The name of the encoder to use
/// - parameter error: An optional pointer to an `NSError` object to receive error information
