...
+ (void)load {
    [NSError setUserInfoValueProviderForDomain:SFBAudioExporterErrorDomain
...
+ (BOOL)exportFromDecoder:(id<SFBPCMDecoding>)decoder toURL:(NSURL *)targetURL error:(NSError **)error {
    ...
    AVAudioFile *outputFile = [[AVAudioFile alloc] initForWriting:targetURL
                                                         settings:decoder.processingFormat.settings
