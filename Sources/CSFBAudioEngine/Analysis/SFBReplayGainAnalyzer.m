            {1.00000000000000, -0.51035327095184, -0.31863563325245, -0.20256413484477, 0.14728154134330,
             0.38952639978999, -0.23313271880868, -0.05246019024463, -0.02505961724053, 0.02442357316099,
             0.01818801111503},
...

      {
            ...
            {0.53648789255105, -0.42163034350696, -0.00275953611929, 0.04267842219415, -0.10214864179676,
             0.14590772289388, -0.02459864859345, -0.11202315195388, -0.04060034127000, 0.04788665548180,
             -0.02217936801134},
            {1.00000000000000, -0.25049871956020, -0.43193942311114, -0.03424681017675, -0.04678328784242,
             0.26408300200955, 0.15113130533216, -0.17556493366449, -0.18823009262115, 0.05477720428674,
             0.04704409688120},
...
- (BOOL)analyzeLeftSamples:(const float *)leftSamples
              rightSamples:(const float *)rightSamples
               sampleCount:(size_t)sampleCount
                  isStereo:(BOOL)stereo;
@end
...
- (NSDictionary *)analyzeTrack:(NSURL *)url error:(NSError **)error {
            ...
            *error = SFBErrorWithLocalizedDescription(
                  ...
                  NSLocalizedString(@"The file “%@” does not contain audio at a supported sample rate.", @""), @{
                      NSLocalizedRecoverySuggestionErrorKey :
                            NSLocalizedString(@"Only sample rates of 8.0 kHz, 11.025 kHz, 12.0 kHz, 16.0 kHz, 22.05 "
    ...
    AVAudioFormat *outputFormat = [[AVAudioFormat alloc] initWithCommonFormat:AVAudioPCMFormatFloat32
                                                                   sampleRate:replayGainSampleRate
    ...
    for (;;) {
        ...
        if (isStereo) {
            vDSP_vsmul(outputBuffer.floatChannelData[1], 1, &scale, outputBuffer.floatChannelData[1], 1,
                       (vDSP_Length)frameCount);
            [self analyzeLeftSamples:outputBuffer.floatChannelData[0]
                        rightSamples:outputBuffer.floatChannelData[1]
                         sampleCount:(size_t)frameCount
                            isStereo:YES];
        } else {
            [self analyzeLeftSamples:outputBuffer.floatChannelData[0]
                        rightSamples:NULL
                  ...
                  errorWithDomain:SFBReplayGainAnalyzerErrorDomain
                         ...
                         userInfo:@{
                             NSLocalizedDescriptionKey :
                                   NSLocalizedString(@"The files do not contain sufficient audio for analysis.", @""),
                             NSLocalizedRecoverySuggestionErrorKey :
                                   NSLocalizedString(@"The audio duration is too short for replay gain analysis.", @"")
                         }];
        }
...
- (BOOL)analyzeLeftSamples:(const float *)left_samples
              rightSamples:(const float *)right_samples
               sampleCount:(size_t)num_samples
                  isStereo:(BOOL)stereo {
    ...
    while (batchsamples > 0) {
        ...
        Filter(_lstep + _totsamp, _lout + _totsamp, (size_t)cursamples, _filter.AButter, _filter.BButter, BUTTER_ORDER,
               downsample);
        Filter(_rstep + _totsamp, _rout + _totsamp, (size_t)cursamples, _filter.AButter, _filter.BButter, BUTTER_ORDER,
               downsample);
