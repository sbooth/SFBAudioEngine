...
extension AudioChannelLabel {
	...
	var channelLabelName: String {
		...
		case kAudioChannelLabel_LeftTopMiddle:				return "LeftTopMiddle"
		case kAudioChannelLabel_RightTopMiddle:				return "RightTopMiddle"
		case kAudioChannelLabel_LeftTopRear:				return "LeftTopRear"
		case kAudioChannelLabel_CenterTopRear:				return "CenterTopRear"
		case kAudioChannelLabel_RightTopRear:				return "RightTopRear"
		...
		case kAudioChannelLabel_BinauralLeft:				return "BinauralLeft"
		case kAudioChannelLabel_BinauralRight:				return "BinauralRight"
