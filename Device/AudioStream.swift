...
extension AudioStream.TerminalType: CustomDebugStringConvertible {
	public var debugDescription: String {
		...
		case kAudioStreamTerminalTypeDigitalAudioInterface: 	return "digitalAudioInterface"
		case kAudioStreamTerminalTypeSpeaker:					return "speaker"
		case kAudioStreamTerminalTypeHeadphones:				return "headphones"
		case kAudioStreamTerminalTypeLFESpeaker:				return "lfeSpeaker"
		case kAudioStreamTerminalTypeReceiverSpeaker:			return "receiverSpeaker"
		case kAudioStreamTerminalTypeMicrophone: 				return "microphone"
		case kAudioStreamTerminalTypeHeadsetMicrophone:			return "headsetMicrophone"
		case kAudioStreamTerminalTypeReceiverMicrophone:		return "receiverMicrophone"
