...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/sbooth/CXXCoreAudio", branch: "alignas"),
		.package(url: "https://github.com/sbooth/CXXRingBuffer", branch: "alignas"),
		...
		.package(url: "https://github.com/sbooth/mpg123-binary-xcframework", from: "0.3.0"),
	...
	targets: [
		.target(
			...
			dependencies: [
				...
				.product(name: "CXXSharedMutex", package: "CXXSharedMutex"),
