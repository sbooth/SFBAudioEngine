 ...
 */
+ (nullable instancetype)inputSourceForURL:(NSURL *)url flags:(SFBInputSourceFlags)flags error:(NSError * _Nullable *)error;
 ...
 */
+ (nullable instancetype)inputSourceWithBytes:(const void *)bytes length:(NSInteger)length error:(NSError * _Nullable *)error;
 ...
 * @see SFBInputSourceFlags
 */
+ (nullable instancetype)inputSourceWithBytesNoCopy:(void *)bytes length:(NSInteger)length error:(NSError * _Nullable *)error;
 ...
 */
- (BOOL)openReturningError:(NSError * _Nullable *)error NS_SWIFT_NAME(open());
 ...
 * @return \c YES on success, \c NO otherwise
 */
- (BOOL)closeReturningError:(NSError * _Nullable *)error NS_SWIFT_NAME(close());
 ...
 */
- (BOOL)readBytes:(void *)buffer length:(NSInteger)length bytesRead:(NSInteger *)bytesRead error:(NSError * _Nullable *)error;
...
- (BOOL)getOffset:(NSInteger *)offset error:(NSError * _Nullable *)error NS_SWIFT_NAME(offset());

/*! @brief Returns the length of the input, in bytes */
- (BOOL)getLength:(NSInteger *)length error:(NSError * _Nullable *)error NS_SWIFT_NAME(length());
 ...
 * @return \c YES on success, \c NO otherwise
 */
- (BOOL)seekToOffset:(NSInteger)offset error:(NSError * _Nullable *)error;

@end

@interface SFBInputSource (SFBSignedIntegerReading)
- (BOOL)readInt8:(int8_t *)i8 error:(NSError * _Nullable *)error;
- (BOOL)readInt16:(int16_t *)i16 error:(NSError * _Nullable *)error;
- (BOOL)readInt32:(int32_t *)i32 error:(NSError * _Nullable *)error;
- (BOOL)readInt64:(int64_t *)i64 error:(NSError * _Nullable *)error;
@end

@interface SFBInputSource (SFBUnsignedIntegerReading)
- (BOOL)readUInt8:(uint8_t *)ui8 error:(NSError * _Nullable *)error;
- (BOOL)readUInt16:(uint16_t *)ui16 error:(NSError * _Nullable *)error;
- (BOOL)readUInt32:(uint32_t *)ui32 error:(NSError * _Nullable *)error;
- (BOOL)readUInt64:(uint64_t *)ui64 error:(NSError * _Nullable *)error;
@end
